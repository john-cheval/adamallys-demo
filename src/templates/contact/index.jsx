...
const ContactTemplate = (props) => {
  const { AddressOne, AddressTwo, Email, Fax, MobileNumber, Buttons } =
    props.data;
  ...
  return (
    <main className="mt-[4rem] md:mt-[8rem]" style={{ overflowX: "hidden" }}>
      <div className="flex flex-col  container mx-auto z-[1] relative">
        <div className="flex flex-col lg:flex-row">
          <div className="basis-full md:min-w-[471px] md:basis-[40%] px-[18px] md:px-[30px] pt-[51px] pb-[42px] sm:px-[62px] sm:pt-[68px] sm:pb-[76px]  bg-theme-main">
            <h1 className="font_calibri text-white font-bold text-[30px] md:text-[60px] leading-[30px] md:leading-[62px] mb-6">
              Contact
            </h1>
            ...
            <div className="mt-[45px] inline-flex flex-col items-start gap-[9px]">
              <div className="w-auto border border-white h-[41px] md:h-[46px] pr-[18px] inline-flex items-center gap-[15px] rounded-[30px]">
                ...
                <a
                  ...
                  className="text-[14px] font_calibri leading-[20px] md:text-lg md:leading-[26px] font-light md:font-normal text-white"
                >
                  {MobileNumber}
                </a>
              </div>
              <div className="w-auto border border-white h-[41px] md:h-[46px] pr-[18px] inline-flex items-center gap-[15px] rounded-[30px]">
                ...
                <p className="text-[14px] font_calibri md:text-lg leading-[20px] font-light md:font-normal md:leading-[26px] text-white">
                  {Fax}
                </p>
              </div>
              <div className="w-auto border border-white h-[41px] md:h-[46px] pr-[18px] inline-flex items-center gap-[15px] rounded-[30px]">
          ...
          <div className="basis-full bg-[#F5F6F8] flex items-center justify-center">
            <form
              ...
              className="w-full px-[18px] lg:px-[30px] py-[34px] sm:px-[55px] sm:py-[76px]"
            >
              <div className="flex flex-col gap-4">
                <p className="text-theme-main font-bold text-[25px] text-center md:text-left leading-[28px] md:text-[40px] md:leading-[44px]">
                  Have a Question?
                </p>
              ...
              <div className="flex flex-col justify-center items-center gap-[8px] mt-[23px]">
                ...
                <button
                  ...
                  className={`w-[96px] md:w-[157px] font_calibri flex md:font-bold md:text-lg items-center justify-center gap-[12px] h-[55px] py-1 bg-[text-theme-main] text-white ${
                    submitEnabled ? "bg-theme-main" : "bg-gray-400"
                  }`}
                >
                  Submit
                </button>
